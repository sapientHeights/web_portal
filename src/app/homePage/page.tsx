        ...
        <div className="min-h-screen bg-linear-to-br from-blue-50 via-indigo-50 to-purple-50">
            ...
            <header className="relative z-10">
                <nav className="container mx-auto px-6 py-6 flex flex-col sm:flex-row gap-5 items-center justify-between">
                    <div className="flex items-center space-x-3">
                        <div className="w-12 h-12 bg-linear-to-br from-purple-600 to-blue-600 rounded-full flex items-center justify-center">
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <button onClick={goToLogin} className="px-8 py-3 bg-linear-to-r from-purple-600 to-blue-600 text-white rounded-xl font-semibold hover:from-purple-700 hover:to-blue-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 cursor-pointer">
                            Login
                        </button>
                    </div>
                </nav>
            ...
            <main className="container mx-auto px-6 py-6">
                <div className="text-center max-w-4xl mx-auto mb-16">
                    <div className="mb-8">
                        ...
                        <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                            ...
                            <span className="bg-linear-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent"> Sapient Heights</span>
                        </h1>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
                        <button onClick={goToLogin} className="group px-8 py-4 bg-linear-to-r from-purple-600 to-blue-600 text-white rounded-xl font-semibold hover:from-purple-700 hover:to-blue-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 flex items-center cursor-pointer">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
                    ...
                    <div className="group p-8 bg-white/60 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border border-white/20">
                        <div className="w-16 h-16 bg-linear-to-br from-indigo-500 to-indigo-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                ...
                {/* CTA Section */}
                <div className="text-center bg-linear-to-r from-purple-600 to-blue-600 rounded-3xl p-12 text-white shadow-2xl">
